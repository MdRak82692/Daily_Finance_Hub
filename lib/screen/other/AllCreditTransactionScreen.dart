...
import '../../table_credit/BuildEmptyTable.dart';
import '../../table_credit/BuildTransactionDate.dart';
import '../../table_credit/AmountTable.dart';
...
class AllCreditTransactionScreen extends StatefulWidget {
  final String email;
  final String name;
  final String contactNumber;
  final String password;

  const AllCreditTransactionScreen({
    super.key,
    required this.email,
    required this.name,
  ...
  _AllCreditTransactionScreenState createState() =>
      _AllCreditTransactionScreenState();
}

class _AllCreditTransactionScreenState
    extends State<AllCreditTransactionScreen> {
  ...
  Widget build(BuildContext context) {
    final groupedTransactionData =
        groupedTransactionByDateAndCredit(transactionList);
              ...
              children: [
                ...
                if (transactionList.isEmpty)
                  Padding(
                    ...
                    child: Text(
                      'No Credit Transaction List Available.',
                      style: style(
                        22,
                        color: Colors.black,
                      ),
